...
CITIES <- tibble(
  ...
  name = c(
    ...
    "JACKSON 2 E, WY US",
    "ASPEN 1 SW CO US",
    "BRECKENRIDGE 1 SW CO US",
    "BOISE AIR TERMINAL, ID US"
  ),
  latitude = c(42.36057, 42.9405, 39.17329, 44.46825, 41.9786, 41.4050, 40.0167, 42.2125, 42.95489, 44.8825, 40.7794, 39.8729, 40.48459, 35.8776, 40.77069, 47.44467, 38.93485, 43.4864, 39.19, 39.4861, 43.5667),
  longitude = c(-71.00975, -78.7322, -76.68408, -73.1499, -87.9047, -82.6556, -105.2667, -83.3534, -87.9045, -93.2218, -73.9632, -75.2414, -80.21448, -78.7875, -111.96503, -122.31361, -77.45581, -110.7617, -106.82, -106.0431, -116.2406),
  elevation = c(3.2, 219, 42, 101.1, 191, 241, 1673, 190, 203, 256, 40, 9, 341, 134, 1288, 112, 90, 1893, 2455, 2920, 860.5)
)
